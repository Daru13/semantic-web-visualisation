...
import { DataFrameColumnAnalysis } from '../DataFrameColumnAnalysis'
...
export class SankeyDiagram {
    ...
    column: Column;
    columnAnalysis: DataFrameColumnAnalysis;
    ...
    constructor(column: Column) {
        this.column = column
        this.columnAnalysis = new DataFrameColumnAnalysis(this.column);
